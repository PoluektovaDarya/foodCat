...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] age = {"1-5", "6-10", "11-20", "20+"} ;
...
// связываем картинку из xml файла с кодом
            ...
            DataItem dataItem =
                    dbHelper.getDataItemById(itemId);
        ...
        } else if (("20+".equals(selectedAge)) && ("Худой".equals(selectedBodyType)) && ("Нет".equals(selectedYesNo))) {
            itemId = 16;
            DataItem dataItem = dbHelper.getDataItemById(itemId);
